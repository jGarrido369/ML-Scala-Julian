...
object AAprueba {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val training=spark.read
      ...
      .option("header", "true")
      .option("delimiter", ",")
      .csv("resources/kc_house_data.csv")
      .cache()

    val featureCols = Array("bedrooms","bathrooms","sqft_living","sqft_lot","floors","waterfront","view","condition","grade","sqft_above","sqft_basement","yr_built","yr_renovated","zipcode","lat","long")
